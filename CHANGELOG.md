...
### Добавлено
- Пошаговый интерактивный режим `agentica init` без обязательных аргументов, с выбором стека, целевой директории и состава `AGENTS.md`

### Изменено
- Сборка `AGENTS.md` стала настраиваемой по выбранным секциям во время `init`
- Получение списка доступных стеков вынесено в общий utility для повторного использования между CLI-командами

### Docs / Build
- Обновлена CLI-документация в README под интерактивный сценарий `init`
- Синхронизированы версии пакета, CLI и version badge до `0.2.0`
