# REL-v0.0.9 - Agentica 0.0.9

## Сводка релиза

- **Дата:** 2026-02-20
- **Предыдущая версия:** v0.0.8
- **Новая версия:** v0.0.9
- **Тип релиза:** patch
- **Тег:** v0.0.9
...
- [x] Версии в манифестах синхронизированы с тегом релиза (`package.json` = `0.0.9`)
...
- Обновлена версия пакета в `package.json` до `0.0.9`
...
- [ ] Блокер: отсутствует
- [ ] Риск: публикация зависит от актуальной npm-аутентификации в текущем окружении
