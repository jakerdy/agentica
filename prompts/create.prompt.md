...
2. Запрос требует **архитектурного проектирования** без конкретной фичи (остановись и предложи пользователю воспользоваться агентом: `rnd`).
...
5. Список существующих файлов в `research/` (могут быть релевантные RnD-XXXX).
